...
const EQ::Name g_this_name = EQ::Name::WOODEN_SWORD; // <------------------
...
namespace EQ {
  EQ::Item@ Item_customization() {
    ...
    array< EQ::Item_slot > item_slot = { EQ::Item_slot( EQ::Class::KNIGHT,  EQ::Slot::LEFT_HAND ),
					 ...
					 EQ::Item_slot( EQ::Class::BUILDER, EQ::Slot::LEFT_HAND ),
					 EQ::Item_slot( EQ::Class::BUILDER, EQ::Slot::RIGHT_HAND ),
					 EQ::Item_slot( EQ::Class::BUILDER, EQ::Slot::BACK )};
    array< EQ::Type > type = { EQ::Type::WEAPON, EQ::Type::SWORD };
    Money price = Gold( 002 ) + Silver( 499 ) + Bronze( 900 );
    EQ::Rarity rarity = EQ::Rarity::PRACTISE;
    EQ::Material material = EQ::Material::WOOD;
    // ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^    
