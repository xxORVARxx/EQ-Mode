...
namespace EQ {
  ...
  funcdef f32 On_defend_fptr( CBlob@ _this, Vec2f _world_point, Vec2f _velocity, f32 _damage, CBlob@ _enemy_blob, u8 _custom_data, EQ::Item_data@ _item_data, EQ::Slot _slot );
  funcdef f32 On_attack_fptr( CBlob@ _this, Vec2f _world_point, Vec2f _velocity, f32 _damage, CBlob@ _enemy_blob, u8 _custom_data, EQ::Item_data@ _item_data, EQ::Slot _slot );
           ...
           EQ::On_unequip_anim_fptr@ m_on_unequip_anim_fptr = null;    
              EQ::On_tick_anim_fptr@ m_on_tick_anim_fptr = null;
                ...
                EQ::On_unequip_fptr@ m_on_unequip_fptr = null;
                 ...
                 EQ::On_defend_fptr@ m_on_defend_fptr = null;
                 EQ::On_attack_fptr@ m_on_attack_fptr = null;
